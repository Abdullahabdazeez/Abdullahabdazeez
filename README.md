...
| ****[Abuja Urban Growth Prediction, 2025–2035](https://github.com/Abdullahabdazeez/abuja-urban-growth-ca-markov)**** | Applied a quantity-constrained CA–Markov model to simulate future urban expansion; built-up land increased by **183.45 km² (15.71%)**. Historical validation achieved **49.27% overall accuracy** and **0.366 Kappa**, so the output is presented as a strategic planning scenario. |** | Modelled observed and future urban expansion using a **CA–Markov** framework; validation achieved **49.3% overall accuracy** and **0.37 Kappa**. |
| ****[Lagos Public Transport Accessibility and Spatial Equity]_(https://github.com/Abdullahabdazeez/lagos-public-transport-accessibility)**** | Integrated population and transport-network data to estimate travel-time accessibility; approximately **46.56%** of the analysed population was classified as underserved. |
